...
var TimePlanPlayer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.advanceToStop(this.currentStop, stop_3, undefined, time)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    TimePlanPlayer.prototype.previous = function () {
        ...
        logger_1.Logger.log('TimePlanPlayer.previous() => variables', {
            goBackToStartOfRange: goBackToStartOfRange,
            isPreviousRangeDifferent: isPreviousRangeDifferent,
            isDefinitelyFirstRange: isDefinitelyFirstRange,
            isPreviousRangeNotAParent: isPreviousRangeNotAParent,
            isPreviousRangeInStack: isPreviousRangeInStack,
        });
        if (goBackToStartOfRange) {
            logger_1.Logger.log('TimePlanPlayer.previous() => goBackToStartOfRange', { currentStopHead: currentStopHead });
    ...
    TimePlanPlayer.prototype.advanceToStop = function (from, to, rangeId, time) {
        return __awaiter(this, void 0, void 0, function () {
            var promise, changeCanvas;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        changeCanvas = this.currentStop.canvasIndex !== to.canvasIndex;
                        this.currentStop = to;
