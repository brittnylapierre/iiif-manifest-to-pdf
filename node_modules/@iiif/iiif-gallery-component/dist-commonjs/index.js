    ...
    GalleryComponent.prototype._init = function () {
        ...
        $.views.helpers({
            ...
            galleryThumbSearchResultsTitle: function () {
                ...
                if (searchResults) {
                    if (searchResults > 1) {
                        return utils_1.Strings.format(that.options.data.content.searchResults, searchResults.toString());
                    }
                    return utils_1.Strings.format(that.options.data.content.searchResult, searchResults.toString());
                }
                return null;
            }
        });
