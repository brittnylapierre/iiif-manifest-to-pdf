...
var LanguageMap = /** @class */ (function (_super) {
    ...
    LanguageMap.getValue = function (languageCollection, locale) {
        if (languageCollection.length) {
            if (locale) {
                var language = languageCollection.filter(function (t) { return t.locale === locale || internal_1.Utils.getInexactLocale(t.locale) === internal_1.Utils.getInexactLocale(locale); })[0];
                if (language) {
