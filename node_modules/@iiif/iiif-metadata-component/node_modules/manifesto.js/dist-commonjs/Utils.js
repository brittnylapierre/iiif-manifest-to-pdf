...
var http_status_codes_1 = require("@edsilv/http-status-codes");
...
var Utils = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        if (!(resource.status === http_status_codes_1.OK)) return [3 /*break*/, 3];
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (resource.status === http_status_codes_1.OK || resource.status === http_status_codes_1.MOVED_TEMPORARILY) {
                            return [2 /*return*/, resource];
                        }
                    ...
                    case 7:
                        _a.sent();
                        if (!(resource.status === http_status_codes_1.MOVED_TEMPORARILY || resource.status === http_status_codes_1.UNAUTHORIZED)) return [3 /*break*/, 9];
                        return [4 /*yield*/, Utils.doAuthChain(resource, openContentProviderInteraction, openTokenService, userInteractedWithContentProvider, getContentProviderInteraction, handleMovedTemporarily, showOutOfOptionsMessages)];
                    case 8:
                        _a.sent();
                        _a.label = 9;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(!resource.isResponseHandled && resource.status === http_status_codes_1.MOVED_TEMPORARILY)) return [3 /*break*/, 2];
                ...
                getStoredAccessToken(resource, tokenStorageStrategy).then(function (storedAccessToken) {
                    if (storedAccessToken) {
                        ...
                        resource.getData(storedAccessToken).then(function () {
                            ...
                            if (resource.status === http_status_codes_1.OK) {
                                resolve(handleResourceResponse(resource));
                            }
                            else {
    ...
    Utils.showAuthInteraction = function (resource, tokenStorageStrategy, clickThrough, restricted, login, getAccessToken, storeAccessToken, resolve, reject) {
        if (resource.status === http_status_codes_1.MOVED_TEMPORARILY && !resource.isResponseHandled) {
