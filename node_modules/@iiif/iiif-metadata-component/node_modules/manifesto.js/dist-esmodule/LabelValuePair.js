...
var LabelValuePair = /** @class */ (function () {
    ...
    LabelValuePair.prototype.setLabel = function (value) {
        ...
        if (this.label && this.label.length) {
            var t = this.label.filter(function (x) { return x.locale === _this.defaultLocale || x.locale === Utils.getInexactLocale(_this.defaultLocale); })[0];
            if (t)
                t.value = value;
        }
    };
    ...
    LabelValuePair.prototype.setValue = function (value) {
        ...
        if (this.value && this.value.length) {
            var t = this.value.filter(function (x) { return x.locale === _this.defaultLocale || x.locale === Utils.getInexactLocale(_this.defaultLocale); })[0];
            if (t)
                t.value = value;
        }
    };
