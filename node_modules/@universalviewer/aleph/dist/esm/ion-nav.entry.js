import { r as registerInstance, c as createEvent, f as getIonMode, i as config, h, d as getElement } from './core-684c60cc.js';
import { b as assert } from './helpers-1644482e.js';
...
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './index-f1ea188f.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await import('./swipe-back-5ccee2ef.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
