...
export declare class Utils {
    ...
    static getSceneDistanceFromMesh(mesh: THREE.Mesh, zoomFactor: number, fov: number): number;
    static getSceneDistanceFromModel(model: THREE.Object3D, zoomFactor: number, fov: number): number;
    static getCameraStateFromMesh(mesh: THREE.Mesh, sceneDistance: number): AlCamera;
    static getCameraStateFromModel(model: THREE.Object3D, sceneDistance: number): AlCamera;
    static getCameraPositionFromNode(node: AlNode, radius: number, cameraTarget: THREE.Vector3): THREE.Vector3;
    static getNearFromSceneDistance(sceneDistance: number): number;
    static getFarFromSceneDistance(sceneDistance: number): number;
