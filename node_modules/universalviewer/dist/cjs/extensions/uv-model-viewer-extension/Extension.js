...
var ModelViewerExtension = /** @class */ (function (_super) {
    ...
    ModelViewerExtension.prototype.create = function () {
        ...
        this.extensionHost.subscribe(Events_1.Events.CAMERA_CHANGE, function (orbit) {
    ...
    ModelViewerExtension.prototype.checkForTarget = function () {
        if (this.data.target) {
            ...
            this.extensionHost.publish(BaseEvents_1.BaseEvents.SET_TARGET, Orbit_1.Orbit.fromString(selector));
        }
    };
