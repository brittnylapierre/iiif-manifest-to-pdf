...
var XYWHFragment_1 = require("./XYWHFragment");
...
var OpenSeadragonExtension = /** @class */ (function (_super) {
    ...
    OpenSeadragonExtension.prototype.create = function () {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.METRIC_CHANGE, function () {
            if (!_this.isDesktopMetric()) {
                ...
                _this.extensionHost.publish(BaseEvents_1.BaseEvents.UPDATE_SETTINGS);
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.CLEAR_ANNOTATIONS, function () {
            ...
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.ANNOTATIONS_CLEARED);
            _this.fire(BaseEvents_1.BaseEvents.CLEAR_ANNOTATIONS);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.DOWN_ARROW, function () {
            if (!_this.useArrowKeysToNavigate()) {
                _this.centerPanel.setFocus();
            }
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.END, function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.helper.getLastPageIndex());
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.FIRST, function () {
            _this.fire(BaseEvents_1.BaseEvents.FIRST);
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.helper.getFirstPageIndex());
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.GALLERY_DECREASE_SIZE, function () {
            _this.fire(BaseEvents_1.BaseEvents.GALLERY_DECREASE_SIZE);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.GALLERY_INCREASE_SIZE, function () {
            _this.fire(BaseEvents_1.BaseEvents.GALLERY_INCREASE_SIZE);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.GALLERY_THUMB_SELECTED, function () {
            _this.fire(BaseEvents_1.BaseEvents.GALLERY_THUMB_SELECTED);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.HOME, function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.helper.getFirstPageIndex());
        });
        this.extensionHost.subscribe(Events_1.Events.IMAGE_SEARCH, function (index) {
            _this.fire(Events_1.Events.IMAGE_SEARCH, index);
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, index);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.LAST, function () {
            _this.fire(BaseEvents_1.BaseEvents.LAST);
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.helper.getLastPageIndex());
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.LEFT_ARROW, function () {
            if (_this.useArrowKeysToNavigate()) {
                _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.getPrevPageIndex());
            }
            else {
                _this.centerPanel.setFocus();
            }
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.MINUS, function () {
            _this.centerPanel.setFocus();
        });
        this.extensionHost.subscribe(Events_1.Events.MODE_CHANGE, function (mode) {
            _this.fire(Events_1.Events.MODE_CHANGE, mode);
            _this.mode = new Mode_1.Mode(mode);
            var settings = _this.getSettings();
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.SETTINGS_CHANGE, settings);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.MULTISELECTION_MADE, function (ids) {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.NEXT, function () {
            ...
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.getNextPageIndex());
        });
        this.extensionHost.subscribe(Events_1.Events.NEXT_SEARCH_RESULT, function () {
            _this.fire(Events_1.Events.NEXT_SEARCH_RESULT);
        });
        this.extensionHost.subscribe(Events_1.Events.NEXT_IMAGES_SEARCH_RESULT_UNAVAILABLE, function () {
            _this.fire(Events_1.Events.NEXT_IMAGES_SEARCH_RESULT_UNAVAILABLE);
            _this.nextSearchResult();
        });
        this.extensionHost.subscribe(Events_1.Events.PREV_IMAGES_SEARCH_RESULT_UNAVAILABLE, function () {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.PAGE_DOWN, function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.getNextPageIndex());
        });
        this.extensionHost.subscribe(Events_1.Events.PAGE_SEARCH, function (value) {
            _this.fire(Events_1.Events.PAGE_SEARCH, value);
            _this.viewLabel(value);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.PAGE_UP, function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.getPrevPageIndex());
        });
        this.extensionHost.subscribe(Events_1.Events.PAGING_TOGGLED, function (obj) {
            _this.fire(Events_1.Events.PAGING_TOGGLED, obj);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.PLUS, function () {
            _this.centerPanel.setFocus();
        });
        ...
        this.extensionHost.subscribe(Events_1.Events.PREV_SEARCH_RESULT, function () {
            _this.fire(Events_1.Events.PREV_SEARCH_RESULT);
        });
        this.extensionHost.subscribe(Events_1.Events.PRINT, function () {
            _this.print();
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.RELOAD, function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CLEAR_ANNOTATIONS);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.RIGHT_ARROW, function () {
            if (_this.useArrowKeysToNavigate()) {
                _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.getNextPageIndex());
            }
            else {
        ...
        this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_ANIMATION, function () {
            _this.fire(Events_1.Events.OPENSEADRAGON_ANIMATION);
        });
        this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_ROTATION, function (degrees) {
            _this.fire(Events_1.Events.OPENSEADRAGON_ROTATION, degrees);
        });
        this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_ANIMATION_FINISH, function (viewer) {
            var xywh = _this.centerPanel.getViewportBounds();
            var canvas = _this.helper.getCurrentCanvas();
            if (_this.centerPanel && xywh && canvas) {
                _this.extensionHost.publish(Events_1.Events.XYWH_CHANGE, xywh.toString());
        ...
        this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_ANIMATION_START, function () {
            _this.fire(Events_1.Events.OPENSEADRAGON_ANIMATION_START);
        });
        this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_OPEN, function () {
            if (!_this.useArrowKeysToNavigate()) {
                _this.centerPanel.setFocus();
            }
            _this.fire(Events_1.Events.OPENSEADRAGON_OPEN);
        });
        this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_RESIZE, function () {
            _this.fire(Events_1.Events.OPENSEADRAGON_RESIZE);
        });
        this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_ROTATION, function (rotation) {
            _this.data.rotation = rotation;
            _this.fire(Events_1.Events.OPENSEADRAGON_ROTATION, _this.data.rotation);
        ...
        this.extensionHost.subscribe(Events_1.Events.SEARCH_PREVIEW_FINISH, function () {
            _this.fire(Events_1.Events.SEARCH_PREVIEW_FINISH);
        });
        this.extensionHost.subscribe(Events_1.Events.SEARCH_PREVIEW_START, function () {
            _this.fire(Events_1.Events.SEARCH_PREVIEW_START);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.ANNOTATIONS, function (obj) {
            _this.fire(BaseEvents_1.BaseEvents.ANNOTATIONS, obj);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.ANNOTATION_CANVAS_CHANGE, function (rects) {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, rects[0].canvasIndex);
        });
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.TREE_NODE_SELECTED, function (node) {
            _this.fire(BaseEvents_1.BaseEvents.TREE_NODE_SELECTED, node.data.path);
            _this.treeNodeSelected(node);
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.UP_ARROW, function () {
            if (!_this.useArrowKeysToNavigate()) {
                _this.centerPanel.setFocus();
            }
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.UPDATE_SETTINGS, function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, _this.helper.canvasIndex);
            var settings = _this.getSettings();
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.SETTINGS_CHANGE, settings);
        });
    ...
    OpenSeadragonExtension.prototype.checkForTarget = function () {
        if (this.data.target) {
            ...
            this.extensionHost.publish(BaseEvents_1.BaseEvents.SET_TARGET, XYWHFragment_1.XYWHFragment.fromString(selector));
        }
    };
    OpenSeadragonExtension.prototype.checkForAnnotations = function () {
        if (this.data.annotations) {
            ...
            if (Array.isArray(annotations)) {
                ...
                this.extensionHost.publish(BaseEvents_1.BaseEvents.CLEAR_ANNOTATIONS);
            }
    ...
    OpenSeadragonExtension.prototype.annotate = function (annotations, terms) {
        ...
        this.extensionHost.publish(BaseEvents_1.BaseEvents.ANNOTATIONS, annotationResults);
    ...
    OpenSeadragonExtension.prototype.checkForSearchParam = function () {
        ...
        if (highlight) {
            ...
            this.extensionHost.publish(Events_1.Events.SEARCH, highlight);
        }
    };
    OpenSeadragonExtension.prototype.checkForRotationParam = function () {
        ...
        var rotation = this.data
            .rotation;
        if (rotation) {
            this.extensionHost.publish(BaseEvents_1.BaseEvents.SET_ROTATION, rotation);
        }
    };
    ...
    OpenSeadragonExtension.prototype.clearAnnotations = function () {
        ...
        this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, this.helper.canvasIndex);
    };
    OpenSeadragonExtension.prototype.prevSearchResult = function () {
        ...
        for (var i = this.annotations.length - 1; i >= 0; i--) {
            ...
            if (result.canvasIndex <= this.getPrevPageIndex()) {
                foundResult = result;
                this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, foundResult.canvasIndex);
                break;
            }
        }
    };
    OpenSeadragonExtension.prototype.nextSearchResult = function () {
        ...
        for (var i = 0; i < this.annotations.length; i++) {
            ...
            if (result && result.canvasIndex >= this.getNextPageIndex()) {
                this.extensionHost.publish(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, result.canvasIndex);
                break;
            }
        }
    };
        ...
        this.getSearchResults(searchUri, terms, this.annotations, function (annotations) {
            ...
            if (annotations.length) {
                ...
                that.showMessage(that.data.config.modules.genericDialogue.content.noMatches, function () {
                    _this.extensionHost.publish(BaseEvents_1.BaseEvents.ANNOTATIONS_EMPTY);
                });
            }
        });
    };
