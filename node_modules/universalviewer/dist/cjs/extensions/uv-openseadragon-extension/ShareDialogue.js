...
var ShareDialogue = /** @class */ (function (_super) {
    ...
    function ShareDialogue($element) {
        ...
        _this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_OPEN, function () {
            _this.update();
        });
        _this.extensionHost.subscribe(Events_1.Events.OPENSEADRAGON_ANIMATION_FINISH, function () {
            _this.update();
        });
        return _this;
    }
