...
var ContentLeftPanel = /** @class */ (function (_super) {
    ...
    ContentLeftPanel.prototype.create = function () {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.ANNOTATIONS, function () {
            _this.databindThumbsView();
            _this.databindGalleryView();
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.ANNOTATIONS_CLEARED, function () {
            _this.databindThumbsView();
            _this.databindGalleryView();
        });
    ...
    ContentLeftPanel.prototype.openTreeView = function () {
        ...
        this.extensionHost.publish(BaseEvents_1.BaseEvents.OPEN_TREE_VIEW);
    };
    ContentLeftPanel.prototype.openThumbsView = function () {
        ...
        this.extensionHost.publish(BaseEvents_1.BaseEvents.OPEN_THUMBS_VIEW);
    };
