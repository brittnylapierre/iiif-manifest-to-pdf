...
var GalleryView = /** @class */ (function (_super) {
    ...
    GalleryView.prototype.setup = function () {
        ...
        this.galleryComponent.on("thumbSelected", function (thumb) {
            that.extensionHost.publish(BaseEvents_1.BaseEvents.GALLERY_THUMB_SELECTED, thumb);
            that.extensionHost.publish(BaseEvents_1.BaseEvents.THUMB_SELECTED, thumb);
        }, false);
        this.galleryComponent.on("decreaseSize", function () {
            that.extensionHost.publish(BaseEvents_1.BaseEvents.GALLERY_DECREASE_SIZE);
        }, false);
        this.galleryComponent.on("increaseSize", function () {
            that.extensionHost.publish(BaseEvents_1.BaseEvents.GALLERY_INCREASE_SIZE);
        }, false);
    };
