                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this._ebookReader.addEventListener("loadedNavigation", function (e) {
                            _this.extensionHost.publish(Events_1.Events.LOADED_NAVIGATION, e.detail);
                        }, false);
                        this._ebookReader.addEventListener("relocated", function (e) {
                            _this.extensionHost.publish(Events_1.Events.RELOCATED, e.detail);
                            _this._cfi = e.detail.start.cfi;
                            _this.extensionHost.publish(Events_1.Events.CFI_FRAGMENT_CHANGE, _this._cfi);
                        }, false);
                        ...
                        this.extensionHost.subscribe(Events_1.Events.ITEM_CLICKED, function (href) {
                            _this._nextState({
                                cfi: href
                            });
                        });
                        this.extensionHost.subscribe(Events_1.Events.CFI_FRAGMENT_CHANGE, function (cfi) {
                            utils_1.Async.waitFor(function () {
