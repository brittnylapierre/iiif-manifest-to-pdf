                            ...
                            this.player = new MediaElementPlayer($("video")[0], {
                                ...
                                success: function (mediaElement, originalNode) {
                                    ...
                                    mediaElement.addEventListener("play", function () {
                                        that.extensionHost.publish(Events_1.Events.MEDIA_PLAYED, Math.floor(mediaElement.currentTime));
                                    });
                                    mediaElement.addEventListener("pause", function () {
                                        ...
                                        if (Math.floor(mediaElement.currentTime) !=
                                            ...
                                            that.extensionHost.publish(Events_1.Events.MEDIA_PAUSED, Math.floor(mediaElement.currentTime));
                                        }
                                    });
                                    mediaElement.addEventListener("ended", function () {
                                        that.extensionHost.publish(Events_1.Events.MEDIA_ENDED, Math.floor(mediaElement.duration));
                                    });
                                    mediaElement.addEventListener("timeupdate", function () {
                                        that.extensionHost.publish(Events_1.Events.MEDIA_TIME_UPDATE, Math.floor(mediaElement.currentTime));
                                    });
                                },
                            });
                        }
