...
var XYWHFragment_1 = require("../../extensions/uv-openseadragon-extension/XYWHFragment");
...
var OpenSeadragonCenterPanel = /** @class */ (function (_super) {
    ...
    OpenSeadragonCenterPanel.prototype.create = function () {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.ANNOTATIONS, function (args) {
            _this.overlayAnnotations();
            // this.zoomToInitialAnnotation();
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.SETTINGS_CHANGE, function (args) {
        ...
        this.extensionHost.subscribe(Events_1.Events.ZOOM_IN, function () {
            _this.whenCreated(function () {
                _this.zoomIn();
            });
        });
        this.extensionHost.subscribe(Events_1.Events.ZOOM_OUT, function () {
            _this.whenCreated(function () {
                _this.zoomOut();
            });
        });
        this.extensionHost.subscribe(Events_1.Events.ROTATE, function () {
            _this.whenCreated(function () {
                _this.rotateRight();
            });
        });
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.SET_TARGET, function (target) {
            _this.whenLoaded(function () {
                _this.fitToBounds(target, false);
            });
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.SET_ROTATION, function (rotation) {
            _this.whenLoaded(function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                debouncedDoubleClick = (0, Utils_1.debounce)(function (e) {
                    ...
                    _this.extensionHost.publish(Events_1.Events.DOUBLECLICK, {
                ...
                this.viewer.addHandler("resize", function (viewer) {
                    _this.extensionHost.publish(Events_1.Events.OPENSEADRAGON_RESIZE, viewer);
                    _this.viewerResize(viewer);
                });
                this.viewer.addHandler("animation-start", function (viewer) {
                    _this.extensionHost.publish(Events_1.Events.OPENSEADRAGON_ANIMATION_START, viewer);
                });
                this.viewer.addHandler("animation", function (viewer) {
                    _this.extensionHost.publish(Events_1.Events.OPENSEADRAGON_ANIMATION, viewer);
                });
                this.viewer.addHandler("animation-finish", function (viewer) {
                    ...
                    _this.extensionHost.publish(Events_1.Events.OPENSEADRAGON_ANIMATION_FINISH, viewer);
                });
                this.viewer.addHandler("rotate", function (args) {
                    // console.log("rotate");
                    _this.extensionHost.publish(Events_1.Events.OPENSEADRAGON_ROTATION, args.degrees);
                });
    ...
    OpenSeadragonCenterPanel.prototype.openPagesHandler = function () {
        this.extensionHost.publish(Events_1.Events.OPENSEADRAGON_OPEN);
            ...
            var _loop_1 = function (k) {
                ...
                if (rect.width === 1 && rect.height === 1) {
                    ...
                    div.onclick = function (e) {
                        e.preventDefault();
                        _this.extensionHost.publish(BaseEvents_1.BaseEvents.PINPOINT_ANNOTATION_CLICKED, k);
                    };
    ...
    OpenSeadragonCenterPanel.prototype.prevAnnotation = function () {
        ...
        if (foundRect && this.isZoomToSearchResultEnabled()) {
            ...
            if (foundRect.canvasIndex < this.extension.helper.canvasIndex) {
                ...
                this.extensionHost.publish(BaseEvents_1.BaseEvents.ANNOTATION_CANVAS_CHANGE, [
                    foundRect
                ]);
            }
            else {
            ...
            this.navigatedFromSearch = true;
            this.extensionHost.publish(Events_1.Events.PREV_IMAGES_SEARCH_RESULT_UNAVAILABLE);
        }
    };
    OpenSeadragonCenterPanel.prototype.nextAnnotation = function () {
        ...
        if (foundRect && this.isZoomToSearchResultEnabled()) {
            ...
            this.navigatedFromSearch = true;
            this.extensionHost.publish(Events_1.Events.NEXT_IMAGES_SEARCH_RESULT_UNAVAILABLE);
        }
    };
    ...
    OpenSeadragonCenterPanel.prototype.zoomToAnnotation = function (annotationRect) {
        ...
        this.extensionHost.publish(BaseEvents_1.BaseEvents.ANNOTATION_CHANGE);
    };
