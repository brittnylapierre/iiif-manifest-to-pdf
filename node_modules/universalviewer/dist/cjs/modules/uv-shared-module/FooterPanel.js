...
var FooterPanel = /** @class */ (function (_super) {
    ...
    FooterPanel.prototype.create = function () {
        ...
        this.$openButton.onPressed(function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.OPEN);
        });
        this.$feedbackButton.onPressed(function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.FEEDBACK);
        });
        this.$bookmarkButton.onPressed(function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.BOOKMARK);
        });
        this.$shareButton.onPressed(function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.SHOW_SHARE_DIALOGUE, _this.$shareButton);
        });
        this.$embedButton.onPressed(function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.SHOW_EMBED_DIALOGUE, _this.$embedButton);
        });
        this.$downloadButton.onPressed(function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.SHOW_DOWNLOAD_DIALOGUE, _this.$downloadButton);
        });
        this.$moreInfoButton.onPressed(function () {
            _this.extensionHost.publish(BaseEvents_1.BaseEvents.SHOW_MOREINFO_DIALOGUE, _this.$moreInfoButton);
        });
