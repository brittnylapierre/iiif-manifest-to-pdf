        ...
        switch (args.informationType) {
            ...
            case InformationType_1.InformationType.DEGRADED_RESOURCE:
                ...
                loginAction.action = function () {
                    ...
                    _this.extension.extensionHost.publish(BaseEvents_1.BaseEvents.HIDE_INFORMATION);
                    _this.extension.extensionHost.publish(BaseEvents_1.BaseEvents.OPEN_EXTERNAL_RESOURCE, [
                        [resource_1]
                    ]);
                };
