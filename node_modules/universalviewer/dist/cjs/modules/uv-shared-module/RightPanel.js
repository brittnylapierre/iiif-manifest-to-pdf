...
var RightPanel = /** @class */ (function (_super) {
    ...
    RightPanel.prototype.init = function () {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.TOGGLE_EXPAND_RIGHT_PANEL, function () {
    ...
    RightPanel.prototype.toggleFinish = function () {
        ...
        if (this.isExpanded) {
            this.extensionHost.publish(BaseEvents_1.BaseEvents.OPEN_RIGHT_PANEL);
        }
        else {
            this.extensionHost.publish(BaseEvents_1.BaseEvents.CLOSE_RIGHT_PANEL);
        }
