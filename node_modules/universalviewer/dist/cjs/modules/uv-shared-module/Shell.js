...
var Shell = /** @class */ (function (_super) {
    ...
    Shell.prototype.create = function () {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.SHOW_OVERLAY, function () {
            _this.$overlays.show();
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.HIDE_OVERLAY, function () {
            _this.$overlays.hide();
        });
        // Jump link
        ...
        this.$overlays.on("click", function (e) {
            if ($(e.target).hasClass("overlays")) {
                e.preventDefault();
                _this.extensionHost.publish(BaseEvents_1.BaseEvents.CLOSE_ACTIVE_DIALOGUE);
            }
        });
        // create shared views.
