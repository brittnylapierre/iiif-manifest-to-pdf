...
var ThumbsView = /** @class */ (function (_super) {
    ...
    ThumbsView.prototype.create = function () {
        ...
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.CANVAS_INDEX_CHANGE, function (index) {
            _this.selectIndex(parseInt(index));
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.LOGIN, function () {
            _this.loadThumbs();
        });
        this.extensionHost.subscribe(BaseEvents_1.BaseEvents.CLICKTHROUGH, function () {
            _this.loadThumbs();
        });
    ...
    ThumbsView.prototype.createThumbs = function () {
        ...
        this.$thumbs.delegate(".thumb", "click", function (e) {
            ...
            that.extensionHost.publish(BaseEvents_1.BaseEvents.THUMB_SELECTED, data);
            return false;
        });
