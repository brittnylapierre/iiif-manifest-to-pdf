...
export function buildLocalZipHeader({ creationDate = new Date(), filename, data, compressedData, extraDataLength, }) {
...
export function buildCentralFileDirectory({ files, trailingLength, offset }) {
